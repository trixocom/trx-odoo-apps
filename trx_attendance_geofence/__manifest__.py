...
tetrabajo asignada. Si está fuera, el ingreso/egreso se rechaza.
...
* Compatible con hr_homeworking: se valida contra la ubicación que
  corresponde aledía (excepción deledía > día de la semana > ubicación
...
tecada evento de fichaje —ingreso, egreso o intento rechazado— con el
...
Requiere el "Seguimiento de dispositivo ynubicación" de Asistencias
