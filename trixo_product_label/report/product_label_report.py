...
class ReportProductLabel3xA4(models.AbstractModel):
    _name = 'report.trixo_product_label.report_producttemplatelabel3xa4'
    _description = 'Product Label Report 1/3 A4'
